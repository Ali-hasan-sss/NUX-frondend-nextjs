...
function WalletPageContent() {
  ...
  return (
    <div className="min-h-screen bg-transparent pb-24 px-5 py-5">
      ...
      <WalletPayRestaurantDialog open={payOpen} onOpenChange={setPayOpen} />
      <WalletWithdrawDialog open={withdrawOpen} onOpenChange={setWithdrawOpen} />
    </div>
  );
}
