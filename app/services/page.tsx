...
const SERVICE_ENTRANCES: SectionEntrance[] = [
  "slide-left",
  "fade-up",
  "slide-right",
  "zoom-in",
...
function ServicesContent({ isDark }: { isDark: boolean }) {
  ...
  return (
    <main className="pb-16">
      <PageHero isDark={isDark} entrance="fade-scale">
        <h1
          className={cn(
      ...
      <PageSection isDark={isDark} sectionIndex={0} bg="glow" entrance="slide-up" containerClassName="max-w-4xl">
        <Card
          className={cn(
            "border-2",
            isDark
              ...
              >
                <Card
                  className={cn(
                    ...
                    service.featured &&
                      (isDark ? "ring-1 ring-cyan-500/50" : "ring-2 ring-cyan-200"),
                    isDark
