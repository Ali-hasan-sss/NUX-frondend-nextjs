...
export function Hero() {
  ...
  return (
    <motion.section
      ...
      className="relative flex flex-col overflow-hidden min-h-[100dvh] max-h-none xl:max-h-[100dvh]"
    >
      <MarketingHeroBackground isDark={isDark} />

      <div
        className="shrink-0 xl:hidden h-[calc(env(safe-area-inset-top,0px)+6.75rem)] sm:h-[calc(env(safe-area-inset-top,0px)+7.5rem)] md:h-[calc(env(safe-area-inset-top,0px)+8rem)]"
        aria-hidden
      />

      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-1 flex items-start xl:items-center pb-10 sm:pb-12 xl:py-16">
